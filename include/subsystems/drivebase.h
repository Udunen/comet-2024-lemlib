...
class Drivebase
{
    public:
        ...
        pros::IMU getIMU();
        void tankDrive(float left, float right, bool disableCurveDrive = false);
        void arcadeDrive(float drive, float turn, bool disableCurveDrive = false, float desaturateBias = 0.5);
        ...
        void waitUntilDone();
        void waitUntilPercent(float endX, float endY, float percent);
